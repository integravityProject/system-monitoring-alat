				...
				<div class="main-content-nner">
					...
					<div class="form-group">
						...
						<div class="col-sm-3 col-xs-3 ">
						 ...
						 <center><h2>Laporan Pengaduan </br>Parkir Meter </br> Kota Padang
						 </br>
						 <b><?php
				 	if($laporan==1){
				 		echo $hari;
	...
	"dom": 'T<"clear">lfrtip',
        "tableTools": {
            "aButtons": [
                ...
                {
                     "sExtends" : "print",
                     "sMessage": "<h2><center>Laporan Pengaduan <br>Parkir Meter <br> Kota Padang</br><b><?php if($laporan==1){ echo $hari; }else if($laporan==2){ echo $tgl1.' - '.$tgl2; }else if($laporan==3){ echo 'Bulan '. $bulan; }else{ echo $tahun; }?></center></h2>",
