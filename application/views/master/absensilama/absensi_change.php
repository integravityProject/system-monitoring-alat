				...
				<div class="form-group">
			 	...
			 	<div class="form-group">
					...
					<div class="col-sm-6 col-xs-6 ">
						<div class="input-group">
							<input class="form-control date-picker" id="tgl" type="text" data-date-format="yyyy-mm-dd" value="<?=$data[0]->tgl?>" />
			 	...
			 	<div class="form-group">
					...
					<div class="col-sm-6">
						<select class="chosen-select form-control col-xs-6 col-sm-5" id="absen" data-placeholder="Pilih Jabatan">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<textarea class="form-control" id="ket" name="ket" rows="5"  ><?=$data[0]->keterangan?></textarea>
					</div>
				</div>
				<div class="form-group">
