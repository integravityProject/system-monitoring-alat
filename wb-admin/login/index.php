...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Login Page - HMTI Web Admin</title>
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">Web HMTI</span>
									<span class="white" id="id-text2">Application</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; AntiCode HMTI 2015</h4>
							</div>
